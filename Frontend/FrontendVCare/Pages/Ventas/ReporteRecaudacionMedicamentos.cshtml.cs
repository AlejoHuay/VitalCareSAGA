...
{
    public class ReporteRecaudacionMedicamentosModel : BasePageModel
    {
        private readonly ReporteVentasAdapter reporteVentasAdapter;

        public ReporteRecaudacionMedicamentosModel(ReporteVentasAdapter reporteVentasAdapter)
        {
            this.reporteVentasAdapter = reporteVentasAdapter;
        }

        public List<ReporteRecaudacionMedicamentoDto> Reporte { get; set; } = new();
        ...
        public int TotalMedicamentos => Reporte.Count;
        public int TotalUnidadesVendidas => Reporte.Sum(item => item.CantidadVendida);
        public int TotalVentasRelacionadas => Reporte.Sum(item => item.CantidadVentas);
        ...
        public ReporteRecaudacionMedicamentoDto? MedicamentoMasVendido =>
            Reporte.OrderByDescending(item => item.CantidadVendida)
                .ThenByDescending(item => item.TotalRecaudado)
                .FirstOrDefault();

        public ReporteRecaudacionMedicamentoDto? MayorRecaudacion =>
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            try
            {
                Reporte = await reporteVentasAdapter.ObtenerReporteRecaudacionMedicamentosAsync(Desde, Hasta);
            }
            catch
            {
        ...
        public async Task<IActionResult> OnGetDescargarPdfAsync()
        {
            ...
            ArchivoDescargaDto? archivo =
                await reporteVentasAdapter.DescargarReporteRecaudacionMedicamentosPdfAsync(Desde, Hasta);
        ...
        public async Task<IActionResult> OnGetDescargarExcelAsync()
        {
            ...
            ArchivoDescargaDto? archivo =
                await reporteVentasAdapter.DescargarReporteRecaudacionMedicamentosExcelAsync(Desde, Hasta);
